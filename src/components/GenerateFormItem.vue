<template>
    <el-form-item :class="widget.fieldLabelStyle" :label="widget.name" :prop="widget.model">
    ...
    export default {
        ...
        created() {
            if (this.widget.options.remote && this.remote[this.widget.options.remoteFunc]) {
                this.remote[this.widget.options.remoteFunc](this.widget.options.param, this.widget.model, (data) => {
